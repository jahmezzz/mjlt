...
export default function SignupPage() {
  const { signup, googleLogin, currentUser, loading: authLoading } = useAuth();
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-10rem)] py-12">
      <Card className="w-full max-w-md shadow-2xl">
        <CardHeader className="text-center">
          ...
          <CardDescription className="font-body">Join MJLT for exclusive luxury transport.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div>
              <Label htmlFor="fullName" className="font-semibold">Full Name</Label>
              <Input id="fullName" type="text" {...register("fullName")} placeholder="James Bond" />
